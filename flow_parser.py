...
import settings
from feature_processing import calc_raw_features, calc_flow_features
from raw_packets_nfplugin import raw_packets_matrix
...
def main():
    ...
    parse_features_to_csv(args.pcapfile,
